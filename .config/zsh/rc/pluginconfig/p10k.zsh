# Generated by Powerlevel10k configuration wizard on 2020-04-03 at 22:25 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31748.
# Wizard options: nerdfont-complete + powerline, large icons, lean_8colors, 2 lines,
# disconnected, sparse, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=45
